...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[100svh] bg-black text-white overflow-hidden">
      ...
      <div className="container mx-auto h-full px-4 sm:px-6 lg:px-8 flex flex-col justify-between relative z-10 py-6 sm:py-8 md:py-10">
        {/* Top section with Gen Studio X */}
        <div className="pt-8 sm:pt-12 md:pt-16 lg:pt-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight" style={{ color: '#E6C88C' }}>
            Gen Studio X
          </h1>
        </div>
        ...
        <div className="flex flex-col items-end text-right my-auto">
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-[90%] sm:max-w-[80%] md:max-w-[70%] space-y-1">
        ...
        <div className="pb-4 sm:pb-6 md:pb-8">
          <p className="text-xs sm:text-sm md:text-base text-[#E6C88C]">contact@genstudiox.ai</p>
        </div>
      </div>
    </section>
  );
